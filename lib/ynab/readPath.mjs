...
//        vendored bundle; sourcing them is the authorized follow-up #157 — see
...
// for them (and `get_budget` strips `scheduled_transactions[]` at the tool
// boundary), so sourcing them is carved into the authorized follow-up #157
// rather than duplicating the per-resource pulls here — see docs §1.
