 ...
 *   quarterly due date, when both tax years are live (issue #17). Its `taxYear` /
 *   `filingStatus` are ignored: the prior year is derived from the boundary.
 */
 ...
 *   `taxYearLabel` is the report-header string (e.g. 'Tax Year 2025'), sourced from the
 *   active-tax-year rule and naming BOTH years during the changeover (issue #17).
 ...
 *   a date the calendar does not have (e.g. '2025-02-30'), when neither the
 *   profile nor `ytdData` resolves a taxYear + filingStatus, or when the review falls
 *   in the year-changeover window without `ytdData.priorYearClose`.
 */
